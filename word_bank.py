...
import os
subdir = '/Users/Zhe/Desktop/sat_july_2014/word_bank'
...
class dictionary(object):
	def __init__(self):
		self.data,self.ldata = generate_dict(divide_list(read_file("word_bank_"+"Directhits715.txt")),'D')
		#print self.data
		tempdata, templdata =  generate_dict(divide_list(read_file("word_bank_"+"barron800715.txt")),'B')
